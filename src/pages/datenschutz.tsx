...
export default () => (
  <main className={layoutStyles.mainContainer}>
    <h1 className={layoutStyles.mainHeadline}>Datenschutz</h1>
    ...
    <p>
      <strong>Abschluss eines Vertrages &uuml;ber Auftragsverarbeitung</strong>
    </p>{' '}
    <p>
      Um die datenschutzkonforme Verarbeitung zu gew&auml;hrleisten, haben wir
      einen Vertrag &uuml;ber Auftragsverarbeitung mit unserem Hoster
      geschlossen.
    </p>
    ...
    <p>
      ...
      <br />
      E-Mail: ingrid.olbrich@posteo.de
    </p>
    <p>
    ...
    <p>
      Auf unserer Webseite sind unter anderem Tools von Unternehmen mit Sitz in
