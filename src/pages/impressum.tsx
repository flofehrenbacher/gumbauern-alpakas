...
export default () => (
  <main className={layoutStyles.mainContainer}>
    <div className="impressum">
      <h1 className={layoutStyles.mainHeadline}>Impressum</h1>
      <p>Angaben gemäß § 5 TMG</p>
      <p>
        Ingrid Olbrich <br></br>
        Finkenweg 9<br></br>
        92334 Berching <br></br>
      </p>
      <p>
        {' '}
      ...
      <p>
        ...
        Telefon: 01575-4205232<br></br>
        E-Mail:{' '}
        <a href="mailto:ingrid.olbrich@posteo.de">ingrid.olbrich@posteo.de</a>
      </p>
      <p>
